...
It was designed using the east compass already used by James Ladd to rewrite Martin's Fowler implementation in east oriented-manner, but in this version, all public method in all classes return `$this` and only `$this`.
